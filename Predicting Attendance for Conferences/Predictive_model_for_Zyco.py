...
# Business Problem:
# Your company, Zyco Co., organizes free conferences in various locations in India. Recently, the company has found that 
# a lot of candidates are not turning up to the conferences after enrolling themselves. Based on the data collected from 
# the candidates during the registeration process, the company Zyco Co. wants you to identify candidates who are at a risk
# of not attending the conference 
# Task 1
...
#In order to get a sense of the data set at hand, we will start with plotting distributions of the independent variables
